    ...
    <div class="newClass">
        <form action="postnewclass" method="post" enctype="multipart/form-data">
            ...
            <select name="type_file">
                <option selected value="list_class" > Điểm Học Tập  </option>
                <option selected value="list_class" > Vi Phạm Quy chế Thi   </option>
                <option selected value="list_class" > Cảnh Báo Học Vụ </option>
