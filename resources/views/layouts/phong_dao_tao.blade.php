    ...
    <div class="sidebar">
        ...
        <div class="sidebar-inner">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li class="nav-parent">
                    <a href="{{ URL::to('phongDaoTao.newimport') }}" class="test_"><i class="icon-puzzle"></i><span> Import Danh sách </span> </a>
                </li>
                <li class="nav-parent">
                    <a href="{{ URL::to('phongDaoTao.diem_hoc_tap') }}" class="test_"><i class="icon-puzzle"></i><span> Điểm Học Tập  </span> </a>
                </li>
                <li class="nav-parent">
                    <a href="{{ URL::to('phongDaoTao.vi_pham_quyche') }}" class="test_"><i class="icon-puzzle"></i><span> Vi Phạm Quy Chế Thi </span> </a>
                </li>
                <li class="nav-parent">
                    <a href="{{ URL::to('phongDaoTao.canh_bao_hv') }}" class="test_"><i class="icon-puzzle"></i><span> Cảnh Báo Học Vụ </span> </a>
                </li>
                <li class="nav-parent">
                    <a href="{{ URL::to('phongDaoTao.listclass') }}" class="test_"><i class="icon-puzzle"></i><span>Xem danh sách</span> </a>
                </li>
