    ...
    <div class="sidebar">
        ...
        <div class="sidebar-inner">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li class="nav-parent">
                    <a href="{{ URL::to('phongkhcn.newimport') }}" class="test_"><i class="icon-puzzle"></i><span> import Danh Sách </span> </a>
                </li>
                <li class="nav-parent">
                    <a href="{{ URL::to('phongkhcn.listclass') }}" class="test_"><i class="icon-puzzle"></i><span> SV Nghiên Cứu Khoa Học </span> </a>
                </li>
                <li class="nav-parent">
                    <a href="{{ URL::to('phongkhcn.giai_thuong') }}" class="test_"><i class="icon-puzzle"></i><span> Giải Thưởng  </span> </a>
                </li>
                <li class="nav-parent">
                    <a href="{{ URL::to('phongkhcn.listclass') }}" class="test_"><i class="icon-puzzle"></i><span>Xem danh sách</span> </a>
                </li>
               s
