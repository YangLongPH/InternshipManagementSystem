    ...
    <div class="sidebar">
        ...
        <div class="sidebar-inner">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li class="nav-parent">
                    <a href="{{ URL::to('doanVien.newClass') }}" class="test_"><i class="icon-puzzle"></i><span> Import danh sách </span> </a>
                </li>

                <li class="nav-parent">
                    <a href="{{ URL::to('doanvien') }}" class="test_"><i class="icon-puzzle"></i><span> Danh Sách Đoàn Viên  </span> </a>
                </li>
                <li class="nav-parent">
                    <a href="{{ URL::to('dangvien') }}" class="test_"><i class="icon-puzzle"></i><span> DS Đảng Viên </span> </a>
                </li>
                <li class="nav-parent">
                    <a href="{{ URL::to('hoat_dong_doan') }}" class="test_"><i class="icon-puzzle"></i><span> SV Tham Gia Các HĐ </span> </a>
                </li>
                <li class="nav-parent">
                    <a href="{{ URL::to('doanVien.khen_thuong') }}" class="test_"><i class="icon-puzzle"></i><span>SV Vi Phạm  </span> </a>
                </li>
                <li class="nav-parent">
                    <a href="{{ URL::to('doanVien.vi_pham') }}" class="test_"><i class="icon-puzzle"></i><span>SV Khen Thưởng </span> </a>
                </li>
