    ...
    <div class="sidebar">
        ...
        <div class="sidebar-inner">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li class="nav-parent">
                    <a href="{{ URL::to('vanPhongKhoa.newimport') }}" class="test_"><i class="icon-puzzle"></i><span> import</span> </a>
                </li>


                <li class="nav-parent">
                    <a href="{{ URL::to('formdiem') }}" class="test_"><i class="icon-puzzle"></i><span> Danh Sách Các Khoa </span> </a>
                </li>
                <li class="nav-parent">
                    <a href="{{ URL::to('newclass') }}" class="test_"><i class="icon-puzzle"></i><span> Cố Vấn Học Tập </span> </a>
                </li>
                <li class="nav-parent">
                    <a href="{{ URL::to('vanPhongKhoa.listclass') }}" class="test_"><i class="icon-puzzle"></i><span> SV Tham Gia Các HĐ </span> </a>
                </li>
                <li class="nav-parent">
                    <a href="{{ URL::to('vanPhongKhoa.vi_pham') }}" class="test_"><i class="icon-puzzle"></i><span>SV Vi Phạm  </span> </a>
                </li>
                <li class="nav-parent">
                    <a href="{{ URL::to('vanPhongKhoa.khen_thuong') }}" class="test_"><i class="icon-puzzle"></i><span>Khen Thưởng  </span> </a>
                </li>
                <li class="nav-parent">
                    <a href="{{ URL::to('vanPhongKhoa.xem_diem') }}" class="test_"><i class="icon-puzzle"></i><span>Xem Điểm rèn Luyện </span> </a>
                </li>
